...
import BannerImage1 from "../assets/Images/img1.png"
import BannerImage2 from "../assets/Images/img2.png"
import BannerImage3 from "../assets/Images/img3.png"
        ...
        <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
            ...
            <div className='flex flex-col items-center gap-10 lg:flex-row justify-between '>
                ...
                <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                    <h1 className='bg-gradient-to-br from-[#c17af0] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold  lg:w-[70%] '>Our Founding Story</h1>
            ...
            <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                ...
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    <h1 className='bg-gradient-to-b from-[#FF512F] to-[#F09819] bg-clip-text text-4xl font-semibold  lg:w-[70%] '>Our Vision</h1>
                ...
                {/* right box */}
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    <h1 className='bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] bg-clip-text text-4xl font-semibold lg:w-[70%] '>
                        Our Mission
                    </h1>
